...
export const POST = async (req: Request) => {
    try {
      const {animal_id, date_of_entry,common_name,animal_type,cage_number, sex, reason_for_admission} = await req.json();
      console.log(animal_id, date_of_entry,common_name,animal_type,cage_number, sex, reason_for_admission);
